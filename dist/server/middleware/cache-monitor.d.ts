 ...
 */
export declare function getCacheItem(req: Request, res: Response): any;
/**
 * Middleware para adicionar rotas de cache à aplicação
 */
export declare function cacheMonitorMiddleware(req: Request, res: Response, next: NextFunction): any;
