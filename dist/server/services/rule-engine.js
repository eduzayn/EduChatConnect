...
function evaluateGroup(group, context) {
    ...
    return isAnd
        ? conditions.every(condition => evaluateCondition(condition.field, condition.operator, condition.value, context))
        : conditions.some(condition => evaluateCondition(condition.field, condition.operator, condition.value, context));
}
/**
