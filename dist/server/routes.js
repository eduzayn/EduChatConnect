...
export function setupRoutes(router, storage) {
    ...
    router.get('/automations', isAuthenticated, async (req, res, next) => {
        try {
    ...
    router.get('/automations/:id', isAuthenticated, async (req, res, next) => {
        try {
    ...
    router.post('/automations', isAuthenticated, async (req, res, next) => {
        try {
    ...
    router.put('/automations/:id', isAuthenticated, async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
    ...
    router.delete('/automations/:id', isAuthenticated, async (req, res, next) => {
        try {
            const id = parseInt(req.params.id);
